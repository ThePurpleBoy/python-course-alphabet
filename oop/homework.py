    ...
    def __init__(self, width, height):
        for parameter in [width, height]:
            if not isinstance(parameter, (int, float)) or parameter <= 0:
                raise ValueError('Wall parameters should be positive numbers')
        self.width = width
        self.height = height
...
class Roof:
    ...
    def __init__(self, width, height, roof_type):
        for parameter in [width, height]:
            if not isinstance(parameter, (int, float)) or parameter <= 0:
                raise ValueError('Roof parameters should be positive numbers')
        self.width = width
        self.height = height
...
class Window:
    ...
    def __init__(self, width, height):
        for parameter in [width, height]:
            if not isinstance(parameter, (int, float)) or parameter <= 0:
                raise ValueError('Window parameters should be positive numbers')
        self.width = width
        self.height = height
